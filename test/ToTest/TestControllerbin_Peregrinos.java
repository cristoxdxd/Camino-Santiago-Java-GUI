    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        do{
            option = StandarReading.readInt("\n\tFuture Promises School"
                    + "\n1. Show 'Peregrinos' List"
                    + "\n2. Show 'Peregrinos' (one-by-one)"
                    + "\n3. Add a 'Peregrino'"
                    + "\n4. Find data"
                    + "\n5. Update a 'Peregrinos' (by List Number)"
                    + "\n6. Remove a 'Peregrinos' (by List Number)"
            ...
            switch(option){
                case 1:
                    ...
                    System.out.printf("\n%-6s%-40s%-12s%-20s%-30s%-20s","Nro.","Nombre","ID", "Domicilio", "Camino", "Localidades\n");
